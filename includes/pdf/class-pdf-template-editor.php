...
class PDF_Template_Editor {
	...
	public function render_page() {
		...
		(function() {
			...
			window.boostPdfEditorSettings = {
				ajaxUrl: '<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>',
				nonce: '<?php echo esc_attr( wp_create_nonce( 'boost_pdf_template_editor' ) ); ?>',
				templates: <?php echo wp_json_encode( array_keys( $this->templates ) ); ?>,
				strings: {
					saving: '<?php echo esc_js( __( 'Opslaan...', 'bossier-calculator' ) ); ?>',
					saved: '<?php echo esc_js( __( 'Opgeslagen!', 'bossier-calculator' ) ); ?>',
					error: '<?php echo esc_js( __( 'Fout bij opslaan', 'bossier-calculator' ) ); ?>',
					preview: '<?php echo esc_js( __( 'Preview laden...', 'bossier-calculator' ) ); ?>',
					resetConfirm: '<?php echo esc_js( __( 'Weet je zeker dat je de template wilt terugzetten naar de standaard? Dit kan niet ongedaan worden gemaakt.', 'bossier-calculator' ) ); ?>'
				}
			};
		})();
		</script>
		...
		(function($) {
			...
			if (typeof $ === 'undefined' || typeof $.fn === 'undefined') {
				console.error('Boost PDF Editor: jQuery is not available');
				return;
			}
			...
			$(function() {
				...
				console.log('Boost PDF Editor: Initializing with settings:', settings);
				...
				console.log('Boost PDF Editor: Found textareas:', Object.keys(textareas));
				...
				if (typeof wp !== 'undefined' && typeof wp.codeEditor !== 'undefined') {
					$('.boost-template-textarea').each(function() {
						...
						try {
							...
							console.warn('Boost PDF Editor: CodeMirror initialization failed for', template, e);
						}
					});
				}
				...
				// Helper: get AJAX URL
				function getAjaxUrl() {
					return settings.ajaxUrl || (typeof ajaxurl !== 'undefined' ? ajaxurl : '/wp-admin/admin-ajax.php');
				}
				...
				console.log('Boost PDF Editor: Initialized successfully. CodeMirror:', useCodeMirror, 'Templates:', Object.keys(textareas));
			});
		})(jQuery);
		</script>
		<?php
